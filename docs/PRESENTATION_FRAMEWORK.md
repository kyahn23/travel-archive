...
## 슬라이드 5: 프론트엔드 구조 - App Router + 기능 기반
...
## 슬라이드 9: 핵심 기술 결정 2 - 모바일 우선 PWA + 파일 저장 추상화
